...
recpeliculaoserie(TIPO,GENERO,ESTUDIO,DURACION,ESTRENORMIN,ESTRENORMAX,NOMBREPELICULAR,DURACIONR,CLASIFICACIONR,ANIOESTRENOR,
...
recpeliculaoserie(TIPO,GENERO,ESTUDIO,_,_,_,NOMBREPELICULAR,DURACIONR,CLASIFICACIONR,ANIOESTRENOR,
ACTORESPRINCIPALESR,NOMBREIMG,SERVICIO):-TIPO =
...
recpeliculaoserie(TIPO,GENERO,_,_,_,_,NOMBREPELICULAR,DURACIONR,CLASIFICACIONR,ANIOESTRENOR,
ACTORESPRINCIPALESR,NOMBREIMG,SERVICIO):-TIPO =
pelicula,peliculastitulos(PELI,NOMBREPELICULAR,DURACIONR,CLASIFICACIONR,ANIOESTRENOR,
SERVICIO,NOMBREIMG),
generopeliculas(GENERO,LISTAPEL),member(PELI,LISTAPEL),
...
recpeliculaoserie(TIPO,GENERO,ESTUDIO,DURACION,ESTRENORMINR,ESTRENORMAX,NOMBRESERIER,DURACIONR,CLASIFICACIONR,ANIOESTRENOR,
ACTORESPRINCIPALESR,NOMBREIMG,SERVICIO):-TIPO =
serie,duracionseries(DURACION,DMIN,DMAX),seriestitulos(SERI,NOMBRESERIER,DURACIONR,_,CLASIFICACIONR,ANIOESTRENOR,SERVICIO,
...
recpeliculaoserie(TIPO,GENERO,ESTUDIO,_,_,_,NOMBRESERIER,DURACIONR,CLASIFICACIONR,ANIOESTRENOR,
ACTORESPRINCIPALESR,NOMBREIMG,SERVICIO):-TIPO =
serie,seriestitulos(SERI,NOMBRESERIER,DURACIONR,_,CLASIFICACIONR,ANIOESTRENOR,SERVICIO,
NOMBREIMG)
,estudiocinematograficoserie(ESTUDIO,_,ESTUDIOPELICULAS,_),member(SERI,ESTUDIOPELICULAS),
generoseries(GENERO,LISTASERIES),member(SERI,LISTASERIES),
actoresprinci(ACTORESPRINCIPALESR,SERI),!.
...
recpeliculaoserie(TIPO,GENERO,_,_,_,_,NOMBRESERIER,DURACIONR,CLASIFICACIONR,ANIOESTRENOR,
ACTORESPRINCIPALESR,NOMBREIMG,SERVICIO):-TIPO =
serie,seriestitulos(SERI,NOMBRESERIER,DURACIONR,_,CLASIFICACIONR,ANIOESTRENOR,SERVICIO,
NOMBREIMG),
generoseries(GENERO,LISTASERIES),member(SERI,LISTASERIES),
...
generoseries(drama,[gotham,blacklist,anatomiasegungray,you,loscien,orangeisthenewblack,puntociego,gooddoctor,hanna]).
generoseries(accion,[gotham,blacklist,lupin,loscien,hanna]).
generoseries(criminal,[you]).
generoseries(misterio,[puntociego]).
...
estudiocinematograficoserie(warnerbros,"Warner Bros",[puntociego,loscien],[drama,misterio,accion]).
...
estudiocinematograficoserie(amazonstudios,"Amazon Studios",[themaninthehighcastle,americanhorror],[ficcion,horror]).
