...
public class Ingreso extends javax.swing.JFrame {
    ...
    public Ingreso() {
        ...
        jLabel1.setIcon(new ImageIcon("src/img.jpg")); //Sets the image to be displayed as an icon
        //Dimension size = jLabel1.getPreferredSize(); //Gets the size of the image
